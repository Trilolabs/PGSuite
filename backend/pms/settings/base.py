"""
Django base settings for PMS project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='pms_db'),
        'USER': env('DB_USER', default='pms_user'),
        'PASSWORD': env('DB_PASSWORD', default='pms_password'),
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'pms.core.exceptions.custom_exception_handler',
}
